...
pub extern fn webview_dispatch(w: webview_t, @"fn": ?fn (webview_t, ?*c_void) callconv(.C) void, arg: ?*c_void) void;
pub extern fn webview_get_window(w: webview_t) ?*c_void;
...
pub extern fn webview_bind(w: webview_t, name: [*c]const u8, @"fn": ?fn ([*c]const u8, [*c]const u8, ?*c_void) callconv(.C) void, arg: ?*c_void) void;
pub extern fn webview_return(w: webview_t, seq: [*c]const u8, status: c_int, result: [*c]const u8) void;
pub const WEBVIEW_API = @compileError("unable to translate C expr: unexpected token .Keyword_extern"); // src/webview.h:28:9
